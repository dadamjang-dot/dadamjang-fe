...
const ShopFilterSheet = ({ mode, onApply, onCancel }: ShopFilterSheetProps) => {
  ...
  const { draftFilters, startDraft, updateDraft, applyDraft, cancelDraft } =
    useShopFilters();
    ...
    if (mode === "category") {
      ...
      return renderOptions(
        ...
        (categoryId) =>
          updateDraft({
            categoryId:
              draftFilters.categoryId === categoryId ? undefined : categoryId,
            categorySource:
              draftFilters.categoryId === categoryId ? undefined : "filter",
          }),
      );
    }
      ...
      >
        {mode === "category" ? (
          <FilterOptionRow
            ...
            onPress={() =>
              updateDraft({ categoryId: undefined, categorySource: undefined })
            }
          />
        ) : null}
        {renderMode()}
